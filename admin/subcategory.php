...
if(isset($_POST["cate_submit"])) {
	$itemCount = count($_POST["cate_name"]);
		$itemValues=0;
		$query = "INSERT INTO `subcate`(`id`, `name`, `date`, `cid`) VALUES ";
		$queryValue = "";
	...
	$uname =$_POST["cate_name"];
		...
		$sql = "UPDATE `subcate` SET `name`='$uname',`cid`='$scid' WHERE id='$sid'";
...
<section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i>Sub Categories</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
						<li><i class="icon_document_alt"></i>Sub Categories</li>
											</ol>
				</div>
			</div>
              <div class="row">
    ...
    $updname="";
    $id = $_GET['id'];
$sql="SELECT category.name as cname,category.id as cid, subcate.name as sname,subcate.id as subid FROM subcate JOIN category ON subcate.cid=category.id WHERE subcate.id='$id'";
	$run = mysql_query($sql);
               ...
               <div class="row" id="upd_new_hide" style="//display: none">
                     ...
                     <section class="panel">
                          ...
                          <div class="panel-body">
                              <form role="form" action="subcategory.php" method="post">
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              <tr>
                                 ...
                                 <th><i class="icon_document_alt"></i> Sub Category Name</th>
...
function deleteCate() {
	$('tr.del').each(function(index, item){
		jQuery(':checkbox', this).each(function () {
            if ($(this).is(':checked')) {
			var cid = $(this).val();	//$(item).remove();
                                //alert($(this).val());
                                $.post('del.php',{cid:cid},function(data){
